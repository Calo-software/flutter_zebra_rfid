...
struct BarcodeScanner {
  ...
  static func fromList(_ __pigeon_list: [Any?]) -> BarcodeScanner? {
    ...
    let model = __pigeon_list[2] as! String
    let serialNumber = __pigeon_list[3] as! String
...
private class FlutterZebraBarcodePigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 130:
      var enumResult: ScannerConnectionType? = nil
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = ScannerConnectionType(rawValue: enumResultAsInt)
      }
      return enumResult
    case 131:
      var enumResult: ScannerConnectionStatus? = nil
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = ScannerConnectionStatus(rawValue: enumResultAsInt)
      }
      return enumResult
    default:
...
private class FlutterZebraBarcodePigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? BarcodeScanner {
      super.writeByte(129)
      super.writeValue(value.toList())
    } else if let value = value as? ScannerConnectionType {
      super.writeByte(130)
